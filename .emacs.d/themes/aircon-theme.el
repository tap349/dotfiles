...
(custom-theme-set-faces
 ...
 '(tab-bar ((t (:background "#F3F3FA" :foreground "black"))))
 '(tab-bar-tab ((t (:background "#CFCFCF" :box (:line-width 1 :color "#BFBFBF" :style released-button) :weight bold))))
 '(tab-bar-tab-inactive ((t (:background "#E3E3E7" :box (:line-width 1 :color "#E6E6EA")))))
 )

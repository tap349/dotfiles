...
let s:p.normal.checking = copy(s:p.normal.middle)
...
"let s:p.tabline.right = [[s:tundora, '#D8E2E9']]
"let s:p.tabline.right = [[s:tundora, '#F1F1F1']]
"let s:p.tabline.right = [[s:tundora, '#F4F4E6']]
"let s:p.tabline.right = [[s:tundora, '#C5D7D7']]
"let s:p.tabline.right = [[s:tundora, '#C8D7C1']]
"let s:p.tabline.right = [[s:tundora, '#DFE7E8']]
let s:p.tabline.right = [[s:tundora, '#DDDDDF']]

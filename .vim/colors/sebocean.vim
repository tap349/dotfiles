...
"""" GUI
highlight Cursor        gui=none guifg=black guibg=#78A6FF
...
highlight CursorLine    gui=none guibg=#0a1020
...
highlight IncSearch     gui=none guifg=black guibg=#A3DE2A
...
highlight Normal        gui=none guibg=#0f2434 guifg=honeydew2
highlight Question      gui=bold guifg=SeaGreen2 guibg=bg
highlight Search        gui=none guibg=#B4EEB4
...
highlight Visual        guifg=#035678 guibg=#b1e8ff
...
""" tap
hi MatchParen guifg=black guibg=#D0FF4E gui=bold

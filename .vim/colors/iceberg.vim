...
hi! MatchParen ctermbg=237 ctermfg=255 guibg=#3e445e guifg=#D0FF4E gui=bold
...
hi! Search ctermbg=216 ctermfg=234 guibg=#94AEC4 guifg=#392313
...
"hi! Type ctermfg=109 gui=NONE guifg=#A4DEA4 guibg=#1A2938
